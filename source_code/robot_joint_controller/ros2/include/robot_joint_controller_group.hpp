...
#include "robot_msgs/msg/stamped_robot_state.hpp"
...
public:
    ...
    void UpdateFunc(const rclcpp::Time &time, const double &period_seconds);
...
protected:
    ...
    std::shared_ptr<realtime_tools::RealtimePublisher<robot_msgs::msg::StampedRobotState>> controller_stamped_state_publisher_;
